...
public class Board implements java.io.Serializable {
	 ...
	 *           Height of Board
	 */
	public Board(int horizontal, int vertical, PrintWriter out) {
	...
	/**
	 * Represents Board object as a String, with X, O, blanks for board positions
	 * 
	...
	public String toString() {
		...
		for (int i = 0; i < this.vertical; i++) {
			...
			for (int j = 0; j < this.horizontal; j++) {
				...
				default:
					this.output.println("Error in board coloring");
					break;
				}
